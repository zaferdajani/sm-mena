...
export async function GET() {
  ...
  const lines = [
    "# Sawwiq (سوّق)",
    "",
    "> Sawwiq is a marketplace in Jordan where businesses find, compare and hire social media and digital marketing agencies: real portfolios, package prices in Jordanian dinars (JOD), verified client reviews, an AI matchmaker, and contracts with milestone-protected payments. Arabic first (/ar), English at /en.",
    "",
    "Facts:",
    ...
    "",
    "## Main pages",
    `- [Home (Arabic)](${SITE_URL}/ar): feed of agency work in Jordan`,
