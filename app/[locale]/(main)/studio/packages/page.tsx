...
export default async function StudioPackagesPage({ params, searchParams }: PageProps<"/[locale]/studio/packages">) {
  const { locale } = await params;
  // Straight after a new agency saves its page (the second setup step).
