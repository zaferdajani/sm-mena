  ...
  return (
    <div className="flex flex-wrap justify-center gap-2">
      <a
        ...
        className="inline-flex items-center gap-2 rounded-full bg-[#25d366] px-5 py-2.5 text-sm font-semibold text-black"
      ...
      <button
        type="button"
        onClick={share}
        className="inline-flex items-center gap-2 rounded-full border bg-background px-5 py-2.5 text-sm font-medium text-foreground hover:bg-muted"
