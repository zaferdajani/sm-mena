...
- Admin → Features → **Pre-launch home page** (`prelaunch_home`, group Launch) decides what `/` shows. **Off by default** (owner decision, 26 Sep 2026): the landing page is the front page and the teaser lives at `/soon`; its design (dark, dense, weak RTL typography) is not to be used as the front page as it stands.
